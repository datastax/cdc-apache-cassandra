...
Download the change agent that matches your Cassandra type and version, `agent-<type>-<version>.jar` file,  file from the https://downloads.datastax.com/#cdc[DataStax downloads page].
