...
| Apache Cassandra 3.x | Apache Pulsar | agent-c3-pulsar-<version>.jar
| Apache Cassandra 3.x | Luna Streaming | agent-c3-luna-<version>.jar
| Apache Cassandra 4.x | Apache Pulsar | agent-c4-pulsar-<version>.jar
| Apache Cassandra 4.x | Luna Streaming | agent-c4-luna-<version>.jar
| DSE 6.8.16+ | Apache Pulsar | agent-dse4-pulsar-<version>.jar
| DSE 6.8.16+ | Luna Streaming | agent-dse4-luna-<version>.jar
