...
. Download the change agent tar file from the https://downloads.datastax.com/#cac[DataStax downloads page].
...
. Download the NAR file that matches your streaming platform from the https://downloads.datastax.com/#csc[DataStax downloads page].
