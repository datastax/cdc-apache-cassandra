...
The relevant {dsbulk-short} settings configure the CSV connector and can be found in the {dsbulk-repo}/blob/1.10.x/manual/settings.md#connector.csv[{dsbulk-short} repository].
