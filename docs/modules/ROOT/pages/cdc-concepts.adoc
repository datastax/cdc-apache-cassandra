...
:navtitle: Overview
:description: Capture changes in an {cass-reg} database and publish them to {pulsar-reg} as events.
:csharp: C#
...
This section describes how table schema changes are handled in the {cass-reg} Connector for {pulsar-reg}.
...
== Consume change data with {pulsar-reg}

This section describes how to consume change data with {pulsar-reg}.
