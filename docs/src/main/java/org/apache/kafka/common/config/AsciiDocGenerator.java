...
public class AsciiDocGenerator {
    ...
    public void generateConfigDefDoc(Path path, String name, String title, ConfigDef configDef, Class<?> clazz) throws IOException {
        try (FileWriter fileWriter = new FileWriter(path.resolve(name).toFile())) {
            PrintWriter pw = new PrintWriter(fileWriter);
            pw.append("// DO NOT EDIT, Auto-Generated by the org.apache.kafka.common.config.AsciiDocGenerator\n");
            pw.append(String.format(Locale.ROOT, "// DO NOT EDIT, Please see class %s\n",clazz.getName()));
    ...
    public void generateCassourceSourceDocs(String outputDir) throws IOException {
        generateConfigDefDoc(Paths.get(outputDir),
                ...
                CassandraSourceConnectorConfig.class);
