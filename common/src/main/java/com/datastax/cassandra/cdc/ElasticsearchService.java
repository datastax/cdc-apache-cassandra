...
public class ElasticsearchService {
    ...
    public CompletableFuture<Long> getWritetime(MutationKey eventKey) {
        ...
        restHighLevelClient.getAsync(request, RequestOptions.DEFAULT, new ActionListener<GetResponse>() {
            ...
            public void onResponse(GetResponse response) {
                ...
                meterRegistry.counter(MetricConstants.METRICS_PREFIX + "es_cache_miss", eventKey.tags()).increment();
            ...
            public void onFailure(Exception e) {
                meterRegistry.counter(MetricConstants.METRICS_PREFIX + "es_cache_miss_failure", eventKey.tags()).increment();
    ...
    public CompletableFuture<Long> index(final MutationKey eventKey, final Long writetime, final Map<String, Object> source) {
        final String indexName = indexName(eventKey);
        ...
        restHighLevelClient.indexAsync(request, RequestOptions.DEFAULT, new ActionListener<IndexResponse>() {
            ...
            public void onResponse(IndexResponse indexResponse) {
                ...
                meterRegistry.counter(MetricConstants.METRICS_PREFIX + "es_index", eventKey.tags()).increment();
                future.complete(writetime);
            }

            @Override
            public void onFailure(Exception e) {
                meterRegistry.counter(MetricConstants.METRICS_PREFIX + "es_index_error", eventKey.tags()).increment();
                future.completeExceptionally(e);
            }
        });
        return future;
     ...
     **/
    @CachePut(parameters = {"pk"}, async = true)
    public CompletableFuture<Long> delete(final MutationKey eventKey, final Long writetime) {
        ...
        restHighLevelClient.deleteAsync(request, RequestOptions.DEFAULT, new ActionListener<DeleteResponse>() {
            ...
            public void onResponse(DeleteResponse indexResponse) {
                ...
                meterRegistry.counter(MetricConstants.METRICS_PREFIX + "es_delete", eventKey.tags()).increment();
                future.complete(writetime);
            }

            @Override
            public void onFailure(Exception e) {
                meterRegistry.counter(MetricConstants.METRICS_PREFIX + "es_delete_error", eventKey.tags()).increment();
                future.completeExceptionally(e);
            }
        });
