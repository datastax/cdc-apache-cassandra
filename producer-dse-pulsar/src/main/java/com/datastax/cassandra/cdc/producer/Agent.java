...
public class Agent {
    ...
    static void startCdcProducer(String agentArgs) throws Exception {
        ...
        OffsetFileWriter offsetFileWriter = new OffsetFileWriter(DatabaseDescriptor.getCDCLogLocation().getAbsolutePath());
        ...
        CommitLogProcessor commitLogProcessor = new CommitLogProcessor(DatabaseDescriptor.getCDCLogLocation().getAbsolutePath(), config, commitLogTransfer, offsetFileWriter, commitLogReaderProcessor);
