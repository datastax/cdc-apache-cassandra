...
public class CassandraToKafkaMigratorTest {

    @Mock private TableExporter exporter;
    @Mock private KafkaImporter importer;

    private CassandraToKafkaMigrator migrator;

    @BeforeEach
    public void init() {
        MockitoAnnotations.openMocks(this);
        migrator = new CassandraToKafkaMigrator(exporter, importer);
    }
    ...
    public void testMigrateExportFailed() {
        ...
        assertEquals(ExitStatus.STATUS_ABORTED_TOO_MANY_ERRORS, status);
        Mockito.verifyNoMoreInteractions(importer, exporter);
    }
}
