...
/**
 * Base class for producer unit tests with 2 cassandra nodes.
 */
@Slf4j
public abstract class PulsarDualProducerTests {
    ...
    public PulsarDualProducerTests(ProducerTestUtil.Version version)
    {
