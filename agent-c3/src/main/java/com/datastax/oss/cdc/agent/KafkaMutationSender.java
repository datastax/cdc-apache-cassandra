...
@Slf4j
public class KafkaMutationSender extends AbstractKafkaMutationSender<CFMetaData> {
    ...
    @Override
    public Object cqlToAvro(CFMetaData tableMetadata, String columnName, Object value) {
        ColumnDefinition columnMetadata = tableMetadata.getColumnDefinition(
